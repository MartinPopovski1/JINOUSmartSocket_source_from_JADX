...
public class ViewDragHelper {
    ...
    private static final Interpolator sInterpolator = new C00461();
    ...
    private final Runnable mSetIdleRunnable = new C00472();
    private int mTouchSlop;
    private int mTrackingEdges;
    private VelocityTracker mVelocityTracker;

    static class C00461 implements Interpolator {
        C00461() {
        }
